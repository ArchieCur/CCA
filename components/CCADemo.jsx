    ...
    <div style={{
      ...
      <div style={{
        ...
        {[
          ...
          { id: "result", label: grading ? `Result: ${gradeColor?.label || grading.grade}` : "Result" }
        ].map(tab => (
          <button
            key={tab.id}
        ...
        {activeTab === "rubric" && (
          <div>
            <p style={{ fontSize: "14px", color: "#94a3b8", marginBottom: "16px", lineHeight: "1.7" }}>
              ...
              The AI grader evaluates open-ended responses against three concepts — not requiring exact
              language, but requiring demonstrated understanding of the underlying reasoning.
            </p>
            <div style={{
              background: "#0d1424",
              border: "1px solid #2a3a5c",
              ...
              <span style={{ color: "#4ade80", fontFamily: "monospace", fontWeight: "bold" }}>PASS</span>
              {" — All three concepts demonstrated clearly."}&nbsp;&nbsp;
              <span style={{ color: "#86efac", fontFamily: "monospace", fontWeight: "bold" }}>WEAK PASS</span>
              {" — Core architectural insight present; one concept incomplete."}&nbsp;&nbsp;
              <span style={{ color: "#f87171", fontFamily: "monospace", fontWeight: "bold" }}>FAIL</span>
              {" — Conceptual threshold not crossed, or Concept 1 disqualified by prompt-change recommendation."}
            </div>
            ...
            <div style={{
              ...
              <p style={{ fontSize: "13px", color: "#94a3b8", lineHeight: "1.7", margin: 0 }}>
                ...
                fails SOX requirements. More critically: recommending prompt changes as the enforcement solution
                is a disqualifying error — it proves the candidate believes prompt-level compliance is a viable
                control. This caps the grade at Fail regardless of any other correct observations in the response.
              </p>
            </div>
          </div>
        )}
